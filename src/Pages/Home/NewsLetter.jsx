...
const NewsLetter = () => {
  ...
  return (
    <div className="mb-20 w-11/12 mx-auto">
      ...
      <div className=" lg:grid lg:gap-10 lg:grid-cols-12   rounded-2xl bg-gradient-to-bl from-lime-100 to-lime-900 p-10">
        ...
        <motion.form
          ...
          className="col-span-5  flex flex-col border p-5 md:p-10 rounded-2xl  bg-gradient-to-tr from-lime-100 to-lime-800 gap-5"
        >
